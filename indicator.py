...
iconpath = os.path.join(os.path.dirname(os.path.abspath(__file__)), "msi.png")
...
def build_menu():
    ...
    item_monitor = gtk.MenuItem.new_with_label('Монитор')                 ################# Monitering
